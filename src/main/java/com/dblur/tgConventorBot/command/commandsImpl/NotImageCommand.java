...
public class NotImageCommand implements Command {

    private final SendBotMessageService sendBotMessageService;
    public static final String NOT_IMAGE_MESSAGE = "Присланный документ не является картинкой.\n"
            + "Пришлите верный формат!";

    public NotImageCommand(SendBotMessageService sendBotMessageService) {
